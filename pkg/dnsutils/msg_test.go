...
func TestGetMinimalTTL(t *testing.T) {
	...
	t.Run("multiple_records", func(t *testing.T) {
		...
		m.Ns = append(m.Ns, &dns.SOA{
			Hdr: dns.RR_Header{Name: "a.com.", Rrtype: dns.TypeSOA, Class: dns.ClassINET, Ttl: 100},
		})
...
func TestSetTTL(t *testing.T) {
	m := newMsgWithAnswer("a.com.", 300)
	m.Ns = append(m.Ns, &dns.SOA{
		Hdr: dns.RR_Header{Name: "a.com.", Rrtype: dns.TypeSOA, Class: dns.ClassINET, Ttl: 600},
	})
