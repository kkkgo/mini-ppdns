...
// Return the minimal ttl of this msg.
// If msg m has no record, returns 0.
...
// Update all records' ttl to ttl, except opt record.
...
// Subtract delta from every m's RR.
// If RR's TTL is smaller than delta, SubtractTTL
// returns overflowed = true.
